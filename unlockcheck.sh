...
format_result() {
    ...
    # Column 3: Status detail (pad to fixed display width: 24 display chars)
    local detail_formatted=$(pad_to_width "$detail" 24)
...
run_all_checks() {
    ...
    local header_status=$(pad_to_width "解锁状态" 24)
