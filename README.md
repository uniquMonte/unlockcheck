...
BRANCH=claude/ai-service-status-check-011CV5tiAjexptjDhAwugkLT bash <(curl -Ls https://raw.githubusercontent.com/uniquMonte/unlockcheck/claude/ai-service-status-check-011CV5tiAjexptjDhAwugkLT/install.sh)
```
