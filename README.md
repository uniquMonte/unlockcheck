...
IP 地址: 104.21.45.123
IP 类型: 原生住宅IP                    # 绿色显示
使用地: 美国 加利福尼亚州 洛杉矶       # IP地理位置
注册地: Cloudflare Inc.                # ISP注册信息
ISP: Cloudflare Inc.
...
**使用地 vs 注册地：**
- **使用地**：IP地址的实际地理位置（根据地理定位数据）
- **注册地**：IP所属组织/ISP的注册信息
- 如果两者差异较大，通常表明是数据中心IP或代理IP，而非原生住宅IP
...
- 显示ASN信息帮助了解IP归属
- **使用地**：显示IP的地理位置（实际连接位置）
- **注册地**：显示IP所属组织的注册信息
- 通过对比使用地和注册地，可更准确判断IP是否为原生IP
