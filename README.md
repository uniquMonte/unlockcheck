...
```bash
bash <(curl -Ls cdn.jsdelivr.net/gh/uniquMonte/unlockcheck/unlockcheck.sh)
```

**IPv4 Only:**
```bash
bash <(curl -Ls cdn.jsdelivr.net/gh/uniquMonte/unlockcheck/unlockcheck.sh) -4
```

**IPv6 Only:**
```bash
bash <(curl -Ls cdn.jsdelivr.net/gh/uniquMonte/unlockcheck/unlockcheck.sh) -6
```
